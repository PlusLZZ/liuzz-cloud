...
public class MyServiceImpl<M extends BaseMapper<T>, T> implements IService<T> {
    ...
    protected Class<M> currentMapperClass() {
        return (Class<M>) ReflectionKit.getSuperClassGenericType(this.getClass(), MyServiceImpl.class, 0);
    }

    protected Class<T> currentModelClass() {
        return (Class<T>) ReflectionKit.getSuperClassGenericType(this.getClass(), MyServiceImpl.class, 1);
    }
